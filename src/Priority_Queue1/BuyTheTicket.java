...
//In this actually the array is the priority of the buyers,one with highest priority gets the ticket first

public class BuyTheTicket {
    public static void main(String[] args) {
        int arr[]={2,3,2,2,4};
        int time=GetThePriorityTime(arr,3);
        System.out.println(time);
    }
    public static int GetThePriorityTime(int arr[],int num){
        int time=0;
